...
function twentyseventeen_setup() {
	...
	register_nav_menus( array(
		...
		'social' => __( 'Social Links Menu', 'twentyseventeen' ),
                'top-left' => __( 'Main Menu Left', 'twentyseventeen' ),
                'top-right' => __( 'Main Menu Right', 'twentyseventeen' ),
                'about-menu' => __( 'About Menu', 'twentyseventeen' ),
                'career-menu' => __( 'Career Menu', 'twentyseventeen' ),
                'technology-menu' => __('Technology Menu', 'twentyseventeen' ),
                'services-menu' => __('Services Menu', 'twentyseventeen' ),
                'shows-menu' => __('Shows Menu', 'twentyseventeen' ),
                'team-menu' => __('Team Menu', 'twentyseventeen' ),
...
register_sidebar( array(
		'name'          => __( 'Logo', 'twentyseventeen' ),
		'id'            => 'logo',
		'description'   => __( 'Site logo', 'twentyseventeen' ),
		'before_widget' => '<section id="%1$s" class="widget %2$s">',
		'after_widget'  => '</section>',
		'before_title'  => '<h2 class="widget-title">',
		'after_title'   => '</h2>',
...
function portfolio_post_type() {
	...
	$args = array(
		'label'               => __( 'portfolio_type', 'text_domain' ),
		'description'         => __( 'Portfolio', 'text_domain' ),
		'labels'              => $labels,
		'supports'            => array( 'title', 'editor', 'excerpt', 'thumbnail', 'custom-fields','comments','author','page-attributes', 'post-formats' ),
...
function custom_post_type() {
	$labels = array(
		...
		'view_item'           => __( 'View Careers', 'text_domain' ),
		'add_new_item'        => __( 'Add New Careers', 'text_domain' ),
		'add_new'             => __( 'Add New', 'text_domain' ),
		'edit_item'           => __( 'Edit Careers', 'text_domain' ),
		'update_item'         => __( 'Update Careers', 'text_domain' ),
		'search_items'        => __( 'Search Product', 'text_domain' ),
		'not_found'           => __( 'Not found', 'text_domain' ),
		'not_found_in_trash'  => __( 'Not found in Trash', 'text_domain' ),
	);
	...
	$args = array(
		'label'               => __( 'careers_type', 'text_domain' ),
	...
	register_post_type( 'careers_type', $args );
}
...
function technology_post_type() {
	...
	$rewrite = array(
		'slug'                => 'our-technologys',
		'with_front'          => true,
		'pages'               => true,
		'feeds'               => true,
	);
	$args = array(
		'label'               => __( 'technology_type', 'text_domain' ),
		'description'         => __( 'Technologies', 'text_domain' ),
		'labels'              => $labels,
		'supports'            => array( 'title', 'editor', 'excerpt', 'thumbnail', 'custom-fields','comments','author','page-attributes', 'post-formats' ),
		'taxonomies'          => array( 'category', 'post_tag' ),
		'hierarchical'        => false,
	...
	register_post_type( 'technology_type', $args );
}
...
function Service_post_type() {
	...
	$args = array(
		'label'               => __( 'Service_type', 'text_domain' ),
...
function Team_post_type() {
	...
	$args = array(
		'label'               => __( 'Team_type', 'text_domain' ),
...
function Video_post_type() {
	...
	$args = array(
		'label'               => __( 'Video_type', 'text_domain' ),
...
function Show_post_type() {
	...
	$args = array(
		'label'               => __( 'Show_type', 'text_domain' ),
		'description'         => __( 'Shows', 'text_domain' ),
		'labels'              => $labels,
		'supports'            => array( 'title', 'editor', 'excerpt', 'thumbnail', 'custom-fields','comments','author','page-attributes', 'post-formats' ),
		'taxonomies'          => array( 'category', 'post_tag' ),
		'hierarchical'        => false,
